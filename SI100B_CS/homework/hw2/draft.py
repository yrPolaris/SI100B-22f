...
#====================================YOUR CODE HERE================================================
        ...
        while rd_num > 0:
            ...
            if atk_num == 2:
                while x > - hd_num1:
                    x -= 1
                    if hd_cards1[1][1] < atk_cards[0][1]:
                        final_ans.append("Pass")
                        hp -= 1
                        x = - hd_num1
                    elif hd_cards1[1][1] == atk_cards[0][1]:
                        if hd_cards1[1][0] <= atk_cards[0][0]:
                            final_ans.append("Pass")
                            hp -= 1
                            x = - hd_num1
                    elif hd_cards1[x][1] == atk_cards[0][1] and hd_cards1[x][0] > atk_cards[0][0] and x - 1>= -hd_num:
                        if hd_cards1[x][1] == hd_cards1[x-1][1]:
                            re = hd_cards1.pop(x).replace("B","D").replace("Z","A").replace("R","K").replace("I","T")
                            if x == -1:
                                x = hd_num1
                            else:
                                x += 1
                            ...
                            hd_num1 -= 1
                            while y > - hd_num1:
                                if hd_cards1[0][1] < atk_cards[0][1]:
                                    final_ans.append("Pass")
                                    hp -= 1
                                    y = - hd_num1
                                    x = - hd_num1
                                elif hd_cards1[0][1] == atk_cards[0][1]:
                                    if hd_cards1[0][0] <= atk_cards[0][0]:
                                        final_ans.append("Pass")
                                        hp -= 1
                                        y = - hd_num1
                                        x = - hd_num1
                                ...
                                if y == hd_num1:
                                    y -= 1
                                if hd_cards1[y][1] == atk_cards[0][1] and hd_cards1[y][0] > atk_cards[0][0]:
                                    ...
                                    y = - hd_num1
                                    x = - hd_num1
                                elif hd_cards1[y][1] > atk_cards[0][1]:
                                    re = hd_cards1.pop(y).replace("B","D").replace("Z","A").replace("R","K").replace("I","T")
                                    if y == -1:
                                        y = hd_num1
                                    else:
                                    ...
                                    y = - hd_num1
                                    x = - hd_num1
                    elif hd_cards1[x][1] > atk_cards[0][1] and x - 1>= -hd_num:
                        if hd_cards1[x][1] == hd_cards1[x-1][1]:
                            re = hd_cards1.pop(x).replace("B","D").replace("Z","A").replace("R","K").replace("I","T")
                            if x == -1:
                                x = hd_num1
